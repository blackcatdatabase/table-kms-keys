...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 6 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 2 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\kms-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\kms-keys)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package kms-keys -Apply
