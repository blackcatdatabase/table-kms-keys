...
final class KmsKeysModule implements ModuleInterface
{
    public function name(): string { return 'table-kms_keys'; }
    public function table(): string { return 'kms_keys'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-kms_providers' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'ux_kms_keys_provider_ref' ];
        $expectedFk  = [ 'fk_kms_keys_provider' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'ux_kms_keys_provider_ref' ],
            'foreignKeys' => [ 'fk_kms_keys_provider' ],
        ];
    }
}
