...
namespace BlackCat\Database\Packages\KmsKeys\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO KmsKeyDto:
...
final class KmsKeyDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'provider_id' ];
    /** @var string[] */
     ...
     * @return KmsKeyDto
     */
    public static function fromRow(array $row): KmsKeyDto
    {
        /** @var KmsKeyDto */
    ...
    public static function fromRowOrNull(?array $row): ?KmsKeyDto
    {
     ...
     */
    public static function toRow(KmsKeyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(KmsKeyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(KmsKeyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(KmsKeyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,KmsKeyDto>
     */
