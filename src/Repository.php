...
{
    private KmsKeyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new KmsKeyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\KmsKeys\Dto\KmsKeyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\KmsKeys\Dto\KmsKeyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\KmsKeys\Dto\KmsKeyDto|null
    {
